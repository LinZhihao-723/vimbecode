...
//! byte range of that source. Rendering is a projection and the source is the truth: a rendered
//! row names the bytes it draws, so a selection is a range of the source and a yank is a slice of
//! the string the block was built from, with nothing to un-render.
//!
